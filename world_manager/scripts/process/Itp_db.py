...
if __name__ == '__main__':
    ...
    try:
        ...
        dao.add_geo_object("Plate_0","Itp",1.97,-0.68,0.45,50,type_name="Itp")
        dao.add_geo_object("Plate_1","Itp",1.54,-0.68,0.45,50,type_name="Itp")
        dao.add_geo_object("Plate_2","Itp",1.97,-0.52,0.45,50,type_name="Itp")
        dao.add_geo_object("Plate_3","Itp",1.54,-0.52,0.45,50,type_name="Itp")
