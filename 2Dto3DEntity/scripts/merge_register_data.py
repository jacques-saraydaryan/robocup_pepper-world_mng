...
class merge_register_data:
    ...
    def configure_ros(self):
        ...
        self._grasp_buffer_size = rospy.get_param('/2d_to_3d_entity/grasp_buffer_size', 100)
        self._grasp_buffer_ttl = rospy.get_param('/2d_to_3d_entity/grasp_buffer_ttl', 2)
        self._grasp_dbscan_eps_value = rospy.get_param('/2d_to_3d_entity/grasp_dbscan_eps_value', 0.1)
        self._grasp_dbscan_min_samples = rospy.get_param('/2d_to_3d_entity/grasp_dbscan_min_samples', 1)
        ...
        rospy.loginfo('[merge_register_data_node] - /2d_to_3d_entity/buffer_size: %i'%self._buffer_size)
        rospy.loginfo('[merge_register_data_node] - /2d_to_3d_entity/buffer_ttl: %f'%self._buffer_ttl)
        rospy.loginfo('[merge_register_data_node] - /2d_to_3d_entity/dbscan_eps_value: %f'%self._dbscan_eps_value)
        rospy.loginfo('[merge_register_data_node] - /2d_to_3d_entity/dbscan_min_samples: %i'%self._dbscan_min_samples)
        rospy.loginfo('[merge_register_data_node] - /2d_to_3d_entity/grasp_buffer_size: %i'%self._grasp_buffer_size)
        rospy.loginfo('[merge_register_data_node] - /2d_to_3d_entity/grasp_buffer_ttl: %f'%self._grasp_buffer_ttl)
        rospy.loginfo('[merge_register_data_node] - /2d_to_3d_entity/grasp_dbscan_eps_value: %f'%self._grasp_dbscan_eps_value)
        rospy.loginfo('[merge_register_data_node] - /2d_to_3d_entity/grasp_dbscan_min_samples: %f'%self._grasp_dbscan_min_samples)
        rospy.loginfo('[merge_register_data_node] - /2d_to_3d_entity/db_radius_to_merge: %f'%self._db_radius_to_merge)
